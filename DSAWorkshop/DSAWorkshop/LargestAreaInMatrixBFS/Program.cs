...
namespace LargestAreaInMatrixDFSIterating
{
    class Program
    {
        ...
        private static Queue<Vertex> stack;
        ...
        private static void BFS(Vertex currentVertex)
        {
            stack.Enqueue(currentVertex);
            while (stack.Count != 0)
            {
                currentVertex = stack.Dequeue();
                currentCount++;
